...
export function GitHubLogo({ size = 24, className }: Props) {
  return (
    <svg width={size} height={size} viewBox="0 0 256 250" className={className} aria-hidden="true" preserveAspectRatio="xMidYMid meet">
